    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{url('home')}}" class="logo">
          ...
          <span class="logo-lg"><b>Maori Crossfit</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li id="liAlmacen" class="treeview">
              ...
              <ul class="treeview-menu">
                <li id="liArticulos"><a href="{{url('almacen/articulo')}}"><i class="fa fa-circle-o"></i> Producto</a></li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017-2020 <a href="http://www.espol.edu.ec/">Espol</a>.</strong> All rights reserved.
      </footer>
